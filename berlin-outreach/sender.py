"""
sender.py — Send cold emails from a berlin_outreach.csv via Gmail SMTP.
...
def send_one(smtp, from_addr: str, to_addr: str, subject: str, body: str) -> None:
    ...
    with open(log_path, "w", newline="", encoding="utf-8") as logfile:
        ...
        try:
            for i, biz in enumerate(businesses, 1):
                ...
                try:
                    send_one(smtp, gmail_user, email, subject, body)
